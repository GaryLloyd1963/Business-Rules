...
{
    [TestFixture]
    public class PaymentReceivedForMembershipUpgradeTests
    {
        private string[] _log;
        ...
        public void GivenAPaymentForABook_WhenTheProcessorIsCalled()
        {
            var paymentReceived = ProcessHelper.CreatePaymentReceivedForAnItem(
                ProductConstants.MainProductType.NonPhysical, ProductConstants.SubProductType.MembershipUpgrade, "The Gym");
        ...
        [Test]
        public void ThenMemberShipUpgradeActivationIsActioned()
        {
            Assert.That(_log.Count(x => x.StartsWith("UMEM")) == 1);
        }
